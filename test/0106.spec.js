    ...
    it("serializer rev 1", (done) => {
        ...
        MID.serializer(msg, {}, (err, data) => {
            ...
            expect(data).to.be.deep.equal({
                mid: 106,
                revision: 1,
                // TODO is the number padding here correct?
                payload: Buffer.from("01030201030123456789040105STATION-TEST        062019-03-08:10:28:29070108Mode 1              09110011                                        12021301141151161170020.1318045.072190000022200000018219999.992200000001302141151161170021.0718046.161190000022200000018219999.992200000002300")
            });
